package com.piggeh.flipnew.services;
...
public class TileCoinService extends TileService {
    ...
    public void onClick(){
        ...
        switch (diceNumber){
            case 1:
                getQsTile().setIcon(Icon.createWithResource(this, R.drawable.ic_coin_head));
                getQsTile().setLabel(String.format(getString(R.string.tile_coin_result),
                        getString(R.string.coin_result_heads)));
                break;
            case 2:
                getQsTile().setIcon(Icon.createWithResource(this, R.drawable.ic_coin_tail));
                getQsTile().setLabel(String.format(getString(R.string.tile_coin_result),
                        getString(R.string.coin_result_tails)));
                break;
        }
